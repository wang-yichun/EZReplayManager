...
public class EZReplayManager : MonoBehaviour
{
	...
	public const string S_PARENT_NAME = "EZReplayM_sParent";
	//default: EZReplayM_sParent
	protected const string S_EZR_ASSET_PATH = "EZReplayManagerAssetPrefabs";

	public const bool showErrors = true;
	//default: true
	public const bool showWarnings = true;
	//default: true
	public const bool showHints = false;
	//default: false

	public const string EZR_VERSION = "1.61";
	...
	protected bool exitOnFinished = false;
	//default: false
	...
	public bool useRecordingGUI = true;
	//default: true
	public bool useReplayGUI = true;
	//default: true
	public bool useDarkStripesInReplay = true;
	//default: true
	public bool precacheGameobjects = true;
	//default: true
	public bool compressSaves = true;
	//default: true
	public bool sendCallbacks = false;
	//default: false
	...
	//default: 3
	public const int minSpeedSliderValue = -3;
	//default: -3
	protected int speedSliderValue = 0;
	//default: 0
	protected int speedSliderValueBackup = 0;
	//default: 0
	...
	protected List<GameObject> markedGameObjects = new List<GameObject> ();
	//don't fill on your own.
	public Dictionary<int, GameObject> instanceIDtoGO = new Dictionary<int, GameObject> ();
...
//		objectToSerialize = (Object2PropertiesMappingListWrapper)bFormatter.Deserialize (stream);
	...
	public void loadFromFile (string filename)
	{
		...
		finishLoading ((Object2PropertiesMappingListWrapper)DeSerializeObject (data));
	}
